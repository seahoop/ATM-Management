...
function HaboAi() {
    ...
    const [messages, setMessages] = useState([
        { text: `Hello ${user?.name || 'customer'}! I'm Habo AI, your personal banking assistant. How can I help you today?`, sender: 'ai' }
    ]);
    ...
    const handleSendMessage = async (e) => {
        ...
        try {
            ...
            setMessages(prev => [...prev, { 
                text: `I'm sorry, I encountered an error while processing your request: ${error.message || 'Unknown error'}. Please try again later.`,
                sender: 'ai' 
            }]);
        } finally {
            setIsLoading(false);
